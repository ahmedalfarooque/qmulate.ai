...
const SERVICES = [
  { id:"stewardship", icon:"◈", label:"Property Stewardship", color:"#00D4FF",
    ...
    <main>
            ...
            <motion.div key={active} initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} exit={{opacity:0,y:-20}} transition={{duration:.4}}>
              <div style={{display:"grid",gridTemplateColumns:"1.2fr 1fr",gap:"clamp(40px,5vw,80px)",alignItems:"start"}} className="grid-2">
                <div>
                  ...
                  <h2 className="t-h2" style={{color:"#F1F5F9",marginBottom:20,lineHeight:1.2}}>{SERVICES[active].headline}</h2>
                  <p className="t-lg" style={{color:"#64748B",marginBottom:36,lineHeight:1.85}}>{SERVICES[active].body}</p>
                ...
                <GlassCard style={{padding:"clamp(24px,3vw,40px)"}}>
                  <div className="t-xs" style={{color:"#334155",marginBottom:20}}>SERVICE DELIVERABLES</div>
            ...
            {[
              ...
              <motion.div key={step.n} {...FU(i*.1)}>
                <GlassCard style={{padding:"clamp(24px,3vw,36px)",textAlign:"center",height:"100%"}}>
                  ...
                  <h3 style={{fontSize:16,fontWeight:700,color:"#F1F5F9",marginBottom:10}}>{step.title}</h3>
                  <p className="t-sm" style={{color:"#64748B",lineHeight:1.75}}>{step.desc}</p>
                </GlassCard>
              </motion.div>
            ))}
          </div>
      ...
      <section className="section-sm" style={{textAlign:"center",position:"relative",overflow:"hidden"}}>
        ...
        <div className="container" style={{position:"relative",zIndex:1}}>
          ...
          <motion.p {...FU(.08)} className="t-lg" style={{color:"#64748B",marginBottom:36}}>All conversations are private and confidential.</motion.p>
