    ...
    <main className="ar">
      ...
      <section style={{minHeight:"60vh",display:"flex",alignItems:"center",position:"relative",overflow:"hidden",paddingTop:"clamp(120px,15vw,180px)",paddingBottom:"clamp(60px,8vw,100px)"}}>
        ...
        <div className="container" style={{position:"relative",zIndex:1}}>
          ...
          <motion.p {...FU(.16)} className="t-xl" style={{color:"#64748B",maxWidth:560,lineHeight:1.85,marginLeft:"auto",textAlign:"right"}}>{t.sub}</motion.p>
      ...
      <section className="section" style={{position:"relative",overflow:"hidden",background:"rgba(6,11,20,.5)"}}>
        <div className="container" style={{position:"relative",zIndex:1,textAlign:"center"}}>
          <SectionHeading eyebrow={t.badge} title={t.h1} center/>
          <motion.p {...FU(.1)} className="t-lg" style={{color:"#64748B",marginTop:16}}>{t.sub}</motion.p>
